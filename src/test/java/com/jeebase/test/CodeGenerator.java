...
//        gc.setOutputDir(projectPath);
		...
		dsc.setUsername("zjweb");
		dsc.setPassword("Zjkj0413");
		dsc.setUrl(
				"jdbc:oracle:thin:@127.0.0.1:1521:xe");
		mpg.setDataSource(dsc);
		// 包配置
		PackageConfig pc = new PackageConfig();
		pc.setModuleName("webchat");// 模块名
		...
		//strategy.setTablePrefix(new String[] { "ZJ_TEST_" });// 此处可以修改为您的表前缀
		...
		strategy.setInclude("T_SYS_SI_PATIENT_INFO");// 表名
