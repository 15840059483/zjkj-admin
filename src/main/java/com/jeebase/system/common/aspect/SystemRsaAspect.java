...
import com.jeebase.system.config.SecretKeyConfig;
...
public class SystemRsaAspect {
    ...
    @Autowired
    private SecretKeyConfig key;

    /**
     * Before切点
     */
    @Pointcut("@annotation(com.jeebase.system.common.annotation.RsaSecurity)")
